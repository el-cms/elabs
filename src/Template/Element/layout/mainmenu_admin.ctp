...
<li>
    <?php echo $this->Html->link(__d('elabs', 'Albums'), ['prefix' => 'admin', 'controller' => 'albums', 'action' => 'index']) ?>
</li>
<li>
    <?php echo $this->Html->link(__d('elabs', 'Notes'), ['prefix' => 'admin', 'controller' => 'notes', 'action' => 'index']) ?>
</li>
<li>
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><?php echo $this->Form->postLink($this->Html->iconT('refresh', __d('elabs', 'Rebuild table')), ['controller' => 'Acts', 'action' => 'clean'], ['escape' => false, 'confirm' => _('Are you sure you want to clear the table and rebuild it ?')]) ?></li>
        <li class="dropdown-header">General</li>
        <li><?php echo $this->Form->postLink($this->Html->iconT('trash', __d('elabs', 'Clear the caches')), ['controller' => 'Maintenance', 'action' => 'clearCache'], ['escape' => false, 'confirm' => _('Are you sure you want to clear the caches ?')]) ?></li>
    </ul>
</li>
<li>
...
?>
<li>
    <?php echo $this->Html->link($this->Html->iconT('eye', __d('elabs', 'View site online')), '/', ['target' => '_blank']) ?>
</li>
<li>
    <?php echo $this->Html->link($this->Html->iconT('sign-out', __d('elabs', 'Logout')), ['prefix' => false, 'controller' => 'users', 'action' => 'logout']) ?>
</li>
<?php
$this->end();

...
echo $this->Form->input('email', ['label' => 'E-Mail', 'required', 'templateVars' => ['help' => __d('users', 'Your email won\'t be given/sold to third-parties')]]);
echo $this->Form->input('username', ['label' => 'User name', 'required', 'templateVars' => ['help' => __d('users', 'User name should be small caps, alphanumeric and underscores only')]]);
echo $this->Form->input('realname', ['label' => 'Real name', 'required', 'templateVars' => ['help' => __d('users', 'Your real name, if you don\'t mind')]]);
echo $this->Form->input('password', ['required', 'templateVars' => ['help' => __d('users', 'A strong password is a good start.')]]);
echo $this->Form->input('password_confirm', ['label' => 'Password confirmation', 'type' => 'password', 'required', 'templateVars' => ['help' => __d('users', 'Verify you didn\'t made a typo')]]);
echo $this->Form->input('bio', ['label' => 'About...', 'type' => 'textarea', 'templateVars' => ['help' => __d('users', 'Tell us why you want to come here')]]);

...
echo $this->Form->input('email', ['label' => __d('elabs', 'E-Mail'), 'required' => true, 'help' => __d('elabs', 'Your email won\'t be given/sold to third-parties')]);
...
echo $this->Form->input('bio', ['label' => __d('elabs', 'About...'), 'type' => 'textarea', 'help' => __d('elabs', 'Tell us why you want to come here')]);

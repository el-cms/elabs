    ...
    <div class="card-main">
        ...
        <div class="card-description">
            ...
            if (!isset($userInfo) || $userInfo):
                echo __d('elabs', '{0}&nbsp;Manager: {1}', '<i class="fa fa-user"></i>', $this->Html->link($data['user']['username'], ['prefix' => false, 'controller' => 'Users', 'action' => 'view', $data['user']['id']]))
                ?><br/>
                <?php
            endif;
        ...
        <div class="card-inner">
            <p>
                <?php echo $this->Elabs->displayMD($data['short_description']) ?>
            </p>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-3">
        <div class="content-sub-heading"><?php echo __d('elabs', 'Links') ?></div>
        <?php echo $this->Html->link(__d('elabs', '{0}&nbsp;{1}', ['<span class="fa fa-fw fa-github-square"></span>', __d('elabs', 'Elabs on Github')]), 'https://github.com/mtancoigne/elabs', ['escape' => false, 'class' => 'btn btn-block']); ?>
        <div class="content-sub-heading"><?php echo __d('elabs', 'Other') ?></div>
        <ul class="list-clear">
            <li><?php echo $this->Html->link(__d('elabs', '{0}&nbsp;{1}', ['<span class="fa fa-fw fa-external-link"></span>', __d('elabs', 'CakePHP')]), 'http://cakephp.org', ['escape' => false]); ?></li>
            <li><?php echo $this->Html->link(__d('elabs', '{0}&nbsp;{1}', ['<span class="fa fa-fw fa-external-link"></span>', __d('elabs', 'Material UI')]), 'http://daemonite.github.io/material/', ['escape' => false]); ?></li>
            <li><?php echo $this->Html->link(__d('elabs', '{0}&nbsp;{1}', ['<span class="fa fa-fw fa-external-link"></span>', __d('elabs', 'FontAwesome')]), 'http://fontawesome.io', ['escape' => false]); ?></li>
            <li><?php echo $this->Html->link(__d('elabs', '{0}&nbsp;{1}', ['<span class="fa fa-fw fa-external-link"></span>', __d('elabs', 'CakePHP - Gravatar plugin')]), 'https://github.com/LowG33kDev/cakephp-gravatar-plugin/', ['escape' => false]); ?></li>
        </ul>
    </div>
    <div class="col-sm-9">
    <h2>Why ?</h2>

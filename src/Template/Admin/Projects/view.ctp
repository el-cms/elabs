...
<ul>
    ...
    <li>
        ...
        echo $this->Form->postLink(__d('elabs', '{0}&nbsp;{1}', ['<span class="fa fa-fw fa-times"></span>', 'Disable']), $link, ['confirm' => __d('elabs','Are you sure you want to disable # {0}?', $project->id), 'escape' => false, 'class' => $class])
        ?>
    </li>

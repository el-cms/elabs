...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mime' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => '44c87096-fc49-4512-85db-afabf1b034f5',
            ...
            'sfw' => 1,
            'status' => 1,
            'user_id' => '33001c81-7dfe-452f-89e2-d40b2164459a',
            'license_id' => 1
        ],
    ];
}

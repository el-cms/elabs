...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_files_users1_idx' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_files_licenses1_idx' => ['type' => 'index', 'columns' => ['license_id'], 'length' => []],
            'fk_files_languages1_idx' => ['type' => 'index', 'columns' => ['language_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_files_languages1' => ['type' => 'foreign', 'columns' => ['language_id'], 'references' => ['languages', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_files_licenses1' => ['type' => 'foreign', 'columns' => ['license_id'], 'references' => ['licenses', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_files_users1' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => '0cbdcaa3-8343-4cfb-937e-928ce5e024e6',
            ...
            'sfw' => 1,
            'status' => 1,
            'created' => '2016-08-06 09:10:35',
            'modified' => '2016-08-06 09:10:35',
            'language_id' => 'L',
            'license_id' => 1,
            'user_id' => '22993be1-6272-4ee0-9589-23ff00120b31'
        ],
    ];
}
